...
/**
 * A FileFinder is an object with a method findFile which takes a fully
 * qualified type name, asynchronously locates the file providing it, and calls
 * the provided callback function with the path to the file.
 * @typedef {{findFile: function(name: string, cb: function(file: string))}}
 */
var FileFinder;
 ...
 * @struct
 */
var TypeManager = function(fileFinder, ternServer) {
  /** @private {FileFinder} */
